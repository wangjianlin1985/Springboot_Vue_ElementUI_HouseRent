...
public class ZuhuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZuhuEntity user = zuhuService.selectOne(new EntityWrapper<ZuhuEntity>().eq("yonghuming", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"zuhu",  "租户" );
    ...
    public R register(@RequestBody ZuhuEntity zuhu){
    	...
    	ZuhuEntity user = zuhuService.selectOne(new EntityWrapper<ZuhuEntity>().eq("yonghuming", zuhu.getYonghuming()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        ZuhuEntity user = zuhuService.selectById(id);
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZuhuEntity zuhu, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZuhuEntity zuhu, HttpServletRequest request){
        EntityWrapper<ZuhuEntity> ew = new EntityWrapper<ZuhuEntity>();
		PageUtils page = zuhuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zuhu), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZuhuEntity> wrapper = new EntityWrapper<ZuhuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = zuhuService.selectCount(wrapper);
