<template>
  <div>
    ...
    <el-form :model="rulesForm" :rules="rules" ref="rulesForm" class="login-form">
      ...
      <el-form-item label="">
                        <a style="margin-right:10px" href="javascript:void(0)" @click="register('zuhu')">注册租户</a>
                                <a style="margin-right:10px" href="javascript:void(0)" @click="register('chuzuren')">注册出租人</a>
                                                                                                                                                      </el-form-item>
